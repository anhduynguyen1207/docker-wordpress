    ...
    <div class="works__cat">
        <ul class="works__catList">
            <li class="works__catItem">
                <a href="<?php echo esc_url( home_url('/works') ).$category->slug ?>" class="selected">All</a>
            </li>
            <?php
            ...
            ?>
            <li class="works__catItem">
                <a href="<?php echo esc_url( home_url('/works-cat/') ).$category->slug ?>"><?php echo $category->name; ?></a>
            </li>
            <?php endforeach; ?>        
        </ul>
    </div>
                    ...
                    <a href="<?php the_permalink(); ?>">
                        ...
                        <div class="article__contents--body">
                            <ul class="body--customList">
                                ...
                                $partner_field = get_field_object('works_partner');
                                if($partner):
                                ?>
                                <li class="body--customListItem<?php echo ' is-'.esc_html(wp_strip_all_tags($partner_field['type'])).' is-'.esc_html(wp_strip_all_tags($partner_field['name'])); ?>"><?php echo esc_html(wp_strip_all_tags($partner)); ?></li>
                                <?php endif; ?>
                                <!-- ↓2 -->
                                <?php 
                                $mainText = get_field('works_mainText');
                                $mainText_field = get_field_object('works_mainText');
                                if($mainText):
                                ?>
                                <li class="body--customListItem omission<?php echo ' is-'.esc_html(wp_strip_all_tags($mainText_field['type'])).' is-'.esc_html(wp_strip_all_tags($mainText_field['name'])); ?>"><?php echo esc_html(wp_strip_all_tags($mainText)); ?></li>
                                <?php endif; ?>
                            </ul>
                        </div>
                    </a>
